...
public class ShowMail {
     ...
     * 附件下载后的存放目录
     */
    private String saveAttachPath = "C:\\Users\\13798\\Desktop\\邮件附件";
    /**
...
//        fileName = fileName.substring(fileName.length() - 6, fileName.length());
    ...
    public static void printMailMessage(List<Message> messageList) throws IOException, MessagingException {
        ...
        for (int i = 0, leng = messageList.size(); i < leng; i++) {
            ...
            re.setAttachPath("C:\\Users\\13798\\Desktop\\邮件附件");
    ...
    public static void main(String[] args) throws MessagingException, IOException, ParseException {
		/*
		 * //163登录信息 //邮件服务器 String host = "mail.xx.com"; //邮箱账号 String username = "xx";
		 * //授权码 String password = "yy"; //协议 String protocol = "imaps"; //只读取该邮箱发来的邮件
		 * String fromMail = null; //只读取该日期以后的邮件 String startDate = null; List<Message>
		 * messageList = filterMessage(getWEMessage(host, username, password, protocol),
		 * fromMail, startDate); printMailMessage(messageList);
		 */
 
        //qq登录信息
        String host2 = "smtp.qq.com";
        String username2 = "137987491@qq.com";
        String password2 = "rhudkmuomuykbhej";
       // String protocol2 = "imaps";
        String protocol2 = "smtp";
        String fromMail2 = null;
        String startDate2 ="2022-10-09 00:00:00";
        ...
        String d_email = "137987491@qq.com"; 
        String d_password = "rhudkmuomuykbhej";
        String d_host = "smtp.qq.com"; 
        String d_port = "587";
